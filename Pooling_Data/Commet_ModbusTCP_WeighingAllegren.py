...
while True:
    ...
    if regs:
        ...
        try:
            ...
            send_data = requests.post("http://127.0.0.1/d-wms/api/Temp_Weighing_Alergen", data={'intTemp':data_suhu}, timeout=1)
            print(send_data)
    ...
    if regs:
        ...
        try:
            print ("kirim data RH")
            send_data = requests.post("http://127.0.0.1/d-wms/api/RH_Weighing_Alergen", data={'intRh':data_rh}, timeout=1)
            print(send_data)
            print(send_data.text)
        except:
            print("error kirim data")
